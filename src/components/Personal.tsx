      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          <Button size="lg" className="text-base px-10 py-7 rounded-full shadow-purple hover:shadow-strong transition-all bg-secondary hover:bg-secondary/90" asChild>
            <a href="https://api.whatsapp.com/send/?phone=5516996403745&text=Ol%C3%A1%21+Gostaria+de+mais+informa%C3%A7%C3%B5es+sobre+a+Tag+It.&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer">
            Comprar Agora
            </a>
          </Button>
        </motion.div>
