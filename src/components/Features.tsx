...
export const Features = () => {
  return (
    <section id="recursos" className="py-32 bg-muted/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="p-8 h-full hover:shadow-soft transition-all duration-500 border hover:border-primary/20 bg-card/50 backdrop-blur-sm group">
                <div className="mb-6 inline-block p-4 bg-gradient-to-br from-primary/10 to-secondary/5 rounded-2xl group-hover:bg-gradient-hero transition-all duration-500">
                ...
                <p className="text-muted-foreground text-lg font-light leading-relaxed">{feature.description}</p>
              </Card>
            </motion.div>
          ))}
        </div>
