...
export const Hero = () => {
  return (
    <section className="relative flex items-center pt-20 pb-32 overflow-hidden bg-gradient-to-br from-cyan-light via-blue-medium to-purple-medium">
      <div className="container mx-auto px-4 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 font-light leading-relaxed opacity-95">
