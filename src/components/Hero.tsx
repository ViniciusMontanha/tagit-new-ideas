                ...
                <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center md:translate-x-0 xl:translate-x-4">
                  ...
                  >
                    {isSlidesLoaded ? (
                      ...
                      <div
                        className="w-full h-auto max-w-[240px] max-[400px]:max-w-[210px] sm:max-w-xs md:max-w-sm lg:max-w-md mx-auto rounded-3xl bg-primary-foreground/20 animate-pulse"
